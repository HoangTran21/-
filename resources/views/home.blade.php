...
<head>
    <meta charset="utf-8">
    <title>Công ty Cổ phần Codemi Việt Nam</title>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid nav-bar bg-transparent">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0">
                <div class="container-fluid"> <!-- Sử dụng container-fluid bao bọc toàn bộ navbar -->
                    <a href="index.html" class="navbar-brand d-flex align-items-center text-center">
                        <div class="icon p-2 me-2">
                            <img class="img-fluid" src="{{ asset('Home/img/logo_codemi.png') }}" alt="Icon" style="width: 80px; height: 80px;">
                        </div>
                        <h1 class="m-0 text-primary">Codemi Việt Nam</h1>
                    </a>
        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    ...
                    <p class="animated fadeIn mb-4 pb-2">Vero elitr justo clita lorem. Ipsum dolor at sed stet sit diam
                        no. Kasd rebum ipsum et diam justo clita et kasd rebum sea elitr.</p>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <a class="cat-item d-block bg-light text-center rounded p-3" href="">
                            <div class="rounded p-4">
                                <div class="icon mb-3">
                                    <img class="img-fluid" src="{{ asset('Home/img/icon-condominium.png') }}"
                                        alt="Icon">
                                </div>
                                <h6>Shop</h6>
                                <span>123 Properties</span>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <a class="cat-item d-block bg-light text-center rounded p-3" href="">
                            <div class="rounded p-4">
                                <div class="icon mb-3">
                                    <img class="img-fluid" src="{{ asset('Home/img/icon-luxury.png') }}"
                                        alt="Icon">
                                </div>
                                <h6>Garage</h6>
                                <span>123 Properties</span>
                    ...
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href=""><img class="img-fluid" src="{{asset ('Home/img/property-2.jpg')}}"
                                                alt=""></a>
                                        <div
                                            class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                                            For Rent</div>
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href=""><img class="img-fluid" src="{{asset ('Home/img/property-3.jpg')}}"
                                                alt=""></a>
                                        <div
                                            class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                                            For Sell</div>
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href=""><img class="img-fluid" src="{{asset ('Home/img/property-4.jpg')}}"
                                                alt=""></a>
                                        <div
                                            class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                                            For Rent</div>
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href=""><img class="img-fluid" src="{{asset ('Home/img/property-5.jpg')}}"
                                                alt=""></a>
                                        <div
                                            class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                                            For Sell</div>
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href=""><img class="img-fluid" src="{{asset ('Home/img/property-6.jpg')}}"
                                                alt=""></a>
                                        <div
                                            class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                                            For Rent</div>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        <h4 class="text-white mb-4">Công ty CP Codemi</h4>
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Số nhà 05, Hải Âu 3, Khu đô thị Vinhomes Marina, phường Vĩnh Niệm, quận Lê Chân, Hải Phòng</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <h4 class="text-white mb-4">Liên kết hữu ích</h4>
                        <a class="btn btn-link text-white-50" href="">Giới thiệu</a>
                        <a class="btn btn-link text-white-50" href="">Thương mại</a>
                        <a class="btn btn-link text-white-50" href="">Chính sách bán hàg</a>    
                    </div>
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="single-footer-component last">
                            ...
                            <div class="body">
                                <div class="gallery-footer">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d400.6281522118906!2d106.690371!3d20.8222407!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x314a718cfbabbeb7%3A0xd11916f72ac1d4ee!2sVinhomes%20Marina%20H%E1%BA%A3i%20Ph%C3%B2ng!5e1!3m2!1svi!2s!4v1713259730092!5m2!1svi!2s" width="230px" height="260px" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="copyright">
                    <div class="row">
                        ...
                        <a class="border-bottom" href="https://htmlcodex.com">Copyright 2024. Bản quyền thuộc về codemivietnam.com</a>
                        </div>
